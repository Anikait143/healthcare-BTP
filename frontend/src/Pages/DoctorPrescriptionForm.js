...
const DoctorPrescriptionForm = (props) => {
  ...
  return (
    <div style={{ height: '450px', overflow: 'auto' }}>
      {val === null ?
    <form style={{ backgroundColor: 'black', color: 'white', width: '500px' }}>
      ...
      <hr style = {{backgroundColor: 'orange', borderWidth: '3px', margin: '10px'}}></hr>
      ...
      <label style = {{margin: '15px'}}>
        ...
        <button style = {{margin: '15px'}} type="button" onClick={handleAddTest}>
          Add Test
        </button>
      </label>
      <hr style = {{backgroundColor: 'orange', borderWidth: '3px', margin: '10px'}}></hr>
      ...
      <button style = {{margin: '15px'}} type="button" onClick={handleAddMedicine}>
        Add Medicine
      </button>
      <hr style = {{backgroundColor: 'orange', borderWidth: '3px', margin: '10px'}}></hr>
      ...
      <Button style = {{margin: '15px', backgroundColor:'orange'}} onClick={handleSubmit}>Submit</Button>
